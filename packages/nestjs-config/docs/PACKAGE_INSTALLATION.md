...
This document explains how packages should be installed in library projects like `@sklv-labs/nestjs-config`.
...
```json
{
  ...
  "devDependencies": {
    ...
    "@nestjs/core": "^11.1.11" // For type checking
